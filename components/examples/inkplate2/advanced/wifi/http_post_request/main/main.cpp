 ...
 * @brief       WiFi HTTP POST request example using webhook.site (Inkplate 2).
 *
 * @details     Demonstrates how to connect Inkplate 2 to a WiFi network and
 ...
 *
 * Configuration:
 * - Menuconfig -> Display Board -> Inkplate2te2
