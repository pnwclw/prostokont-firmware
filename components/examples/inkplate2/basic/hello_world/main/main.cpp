 ...
 * @brief       Basic "Hello World" example for Soldered Inkplate 2.
 *
 * @details     Demonstrates the most basic usage of the Inkplate 2 by
...
extern "C" void app_main(void) {
  ...
  display.setTextSize(1);        // Set text size to 6 (default is 1)
