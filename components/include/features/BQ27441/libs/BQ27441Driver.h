...
#define BQ72441_I2C_TIMEOUT 2000 // ms
...
public:
  ...
  */
  ...
  /**
      ...
      @param dev_handle ESP-IDF I2C master device handle for the BQ27441
      @return true if communication was successful.
  */
  bool begin(i2c_master_dev_handle_t dev_handle);
...
*/
  ...
  // Added by Soldered Electronics. Enable or disable hibernate state to reduce
  // power consumption.
  void shutdown();
...
private:
  ...
  i2c_master_dev_handle_t _i2c_handle; // ESP-IDF I2C device handle
  ...
  */
  ...
  /**
      ...
      @return true on success
  */
  bool writeExtendedData(uint8_t classID, uint8_t offset, uint8_t *data,
                         uint8_t len);
...
extern BQ27441Driver
    lipo; // Use lipo.[] to interact with the library in an Arduino sketch
// Thanks for reading!
